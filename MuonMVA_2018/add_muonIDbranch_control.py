...
#   add_eval_branch("/lustre/cms/store/user/fsimone/Tau3Mu/Analysis/20210605_1119/AnalysedTree_data_2018A_control_5june.root")
#   add_eval_branch("/lustre/cms/store/user/fsimone/Tau3Mu/Analysis/20210605_1120/AnalysedTree_data_2018B_control_5june.root")
#   add_eval_branch("/lustre/cms/store/user/fsimone/Tau3Mu/Analysis/20210605_1121/AnalysedTree_data_2018C_control_5june.root")
#   add_eval_branch("/lustre/cms/store/user/fsimone/Tau3Mu/Analysis/20210605_1122/AnalysedTree_data_2018D_control_5june.root")
#   add_eval_branch("/lustre/cms/store/user/fsimone/Tau3Mu/Analysis/20210605_1118/AnalysedTree_MC_2018DsPhiPi_control_5june.root")

   add_eval_branch("/lustre/cms/store/user/fsimone/Tau3Mu/Analysis/20210730_1657/AnalysedTree_data_2018A_control_30july.root")
   add_eval_branch("/lustre/cms/store/user/fsimone/Tau3Mu/Analysis/20210730_1658/AnalysedTree_data_2018B_control_30july.root")
   add_eval_branch("/lustre/cms/store/user/fsimone/Tau3Mu/Analysis/20210730_1659/AnalysedTree_data_2018C_control_30july.root")
   add_eval_branch("/lustre/cms/store/user/fsimone/Tau3Mu/Analysis/20210730_1700/AnalysedTree_data_2018D_control_30july.root")
   add_eval_branch("/lustre/cms/store/user/fsimone/Tau3Mu/Analysis/20210730_1656/AnalysedTree_MC_2018DsPhiPi_control_30july.root")

...
int main(int narg, char** arg){
    ...
    if((strcmp(type, "MC") == 0 || strcmp(type, "MC_sgn") == 0 ) && 
        ...
        strcmp(datasetName, "2017BdToKK") != 0 && strcmp(datasetName, "2017BdToPiPi") != 0 && strcmp(datasetName, "2017BdToKPi") != 0 && strcmp(datasetName, "2017BdToKPi_2") != 0 &&
        strcmp(datasetName, "2017BsToKK") != 0 && strcmp(datasetName, "2017BsToKK_2") != 0 && strcmp(datasetName, "2017BsToPiPi") != 0 && strcmp(datasetName, "2078BsToKPi") != 0 &&
    ...
    if (strcmp(type, "MC") == 0){
        ...
        // Ds -> Tau -> 3Mu
        if (strcmp(datasetName, "2018Ds") == 0 || strcmp(datasetName, "2017Ds") == 0){
        ...
        //AddFile_MC2017Ds_muonid
        //OutFile_MC2017Ds_muonid

        ntupleClass_muonid class_MC(chain, fileout);
        class_MC.Loop(type, datasetName);
        }
        // B0 -> Tau -> 3Mu
        if (strcmp(datasetName, "2018B0") == 0 || strcmp(datasetName, "2017B0") == 0){
            cout << "MC Dataset : B0 -> Tau -> 3Mu" << endl << endl;
            TChain* chain = new TChain("TreeMakerBkg/ntuple");
        //AddFile_MC2018B0_muonid
        //OutFile_MC2018B0_muonid
        //AddFile_MC2017B0_muonid
        //OutFile_MC2017B0_muonid

        ntupleClass_muonid class_MC(chain, fileout);
        class_MC.Loop(type, datasetName);
        }
        // Bp -> Tau -> 3Mu
        if (strcmp(datasetName, "2018Bp") == 0 || strcmp(datasetName, "2017Bp") == 0){
            cout << "MC Dataset : Bp -> Tau -> 3Mu" << endl << endl;
            TChain* chain = new TChain("TreeMakerBkg/ntuple");
        //AddFile_MC2018Bp_muonid
        //OutFile_MC2018Bp_muonid
        //AddFile_MC2017Bp_muonid
        //OutFile_MC2017Bp_muonid
        ...
        if (strcmp(datasetName, "2018BdToKK") == 0 || strcmp(datasetName, "2018BdToPiPi") == 0 || strcmp(datasetName, "2018BdToKPi") == 0 || strcmp(datasetName, "2018BdToKPi_2") == 0 ||
            strcmp(datasetName, "2018BsToKK") == 0 || strcmp(datasetName, "2018BsToKK_2") == 0 || strcmp(datasetName, "2018BsToPiPi") == 0 || strcmp(datasetName, "2018BsToKPi") == 0 ||
            strcmp(datasetName, "2017BdToKK") == 0 || strcmp(datasetName, "2017BdToPiPi") == 0 || strcmp(datasetName, "2017BdToKPi") == 0 || strcmp(datasetName, "2017BdToKPi_2") == 0 ||
            strcmp(datasetName, "2017BsToKK") == 0 || strcmp(datasetName, "2017BsToKK_2") == 0 || strcmp(datasetName, "2017BsToPiPi") == 0 || strcmp(datasetName, "2017BsToKPi") == 0){
            cout << "MC Dataset : Bd/Bs to KK/PiPi/KPi for muon ID studies" << endl << endl;
            TChain* chain = new TChain("TreeMakerBkg/ntuple");
        //AddFile_MC2018Bkg_muonid
        //OutFile_MC2018Bkg_muonid
        //AddFile_MC2017Bkg_muonid
        //OutFile_MC2017Bkg_muonid

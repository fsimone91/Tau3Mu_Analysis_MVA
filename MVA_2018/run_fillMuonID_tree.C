...
#include "../MuonID_study/MuonMVA_2018/MuonID_common.h"
...
void filltree_MuonID(TTree *tin, TTree *tout, Double_t &value_MuonID){
    ...
    TString weight_path_barrel = "/lustrehome/fsimone/MuonID_study/MuonMVA_2018/"+TMVA_MuonID_inputpath+category+TMVA_MuonID_weightfilename;
    ...
    category = "endcap";
    //Book the MVA method used for MuonID
    TString weight_path_endcap = "/lustrehome/fsimone/MuonID_study/MuonMVA_2018/"+TMVA_MuonID_inputpath+category+TMVA_MuonID_weightfilename;
...
void evaluate_fillMuonID_tree(TString inputFile) 
{
    ...
    Double_t value_MuonID1 = 0;
    Double_t value_MuonID2 = 0;
    Double_t value_MuonID3 = 0;
    //Book output Tree
    ...
    tout1->Branch("MuonID",&value_MuonID1,"MuonID/D");
    TTree *tout2 = new TTree("MuonIDeval_Mu2","MuonIDeval_Mu2");
    tout2->Branch("MuonID",&value_MuonID2,"MuonID/D");
    TTree *tout3 = new TTree("MuonIDeval_Mu3","MuonIDeval_Mu3");
    tout3->Branch("MuonID",&value_MuonID3,"MuonID/D");

    //Read branches, loop on tree, perform evaluate and fill histo
    filltree_MuonID(tin1, tout1, value_MuonID1); 
    filltree_MuonID(tin2, tout2, value_MuonID2); 
    filltree_MuonID(tin3, tout3, value_MuonID3); 

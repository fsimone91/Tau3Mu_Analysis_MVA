...
void BDT_optimal_cut_v2() 
{
    ...
    for(int k=0; k<ncat; k++)
    {
        ...
        if(isXGBoost){
            ...
            X_min = std::min(h_test_signal->GetXaxis()->GetXmin(), h_test_signal->GetXaxis()->GetXmin());
            X_max = std::max(h_test_signal->GetXaxis()->GetXmax(), h_test_signal->GetXaxis()->GetXmax());
       ...
       double Y_max;
       //if(isXGBoost) 
           Y_max = std::max(h_test_signal2->GetMaximum(), h_test_bkg2->GetMaximum());
       //else Y_max = 0.12;

...
void dsphipi_fit_ctrplots() 
{
    ...
    for(int i=0; i<nrun; i++){
        ...
        RooRealVar sigma2("sigma2","Width of Gaussian",0.01,0,0.06);
        
        RooRealVar mass1("mass1","Central value of Gaussian",1.87,1.828,1.89);
        ...
        // Combine the models
        RooRealVar nsig2("nsig2","#signal2 events",8000,0.,50000);
        RooRealVar nsig1("nsig1","#signal1 events",4000,0.,50000);
        RooRealVar nbkg("nbkg","#background events",40000,0.,100000);
        ...
        text->Draw("same");
        c5->Update();
        c5->SaveAs("plots/DsPhiPi_invmass_"+run_lable+".png");
...
//            continue;
            ...
            c2->SaveAs("plots/"+varname+"_"+run_lable+".png");

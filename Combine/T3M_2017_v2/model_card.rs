...
sig_sigma_B1[0.025, 0.001, 0.07];
sig_alpha_B1[ 1, -20., 20.]; 
sig_n_B1[1, 0.0, 5.0]; 
sig_gaus_sigma_B1[0.02,0.0001,0.3];
...
bkg_exp_slope_A1[-5.0,-10.0,-0.01];
bkg_exp_slope_B1[-5.0,-10.0,-0.4];
bkg_exp_slope_C1[-5.0,-10.0,-0.01];
bkg_exp_slope_A2[-5.0,-10.0,-1.5];
bkg_exp_slope_B2[-5.0,-10.0,-0.01];
bkg_exp_slope_C2[-5.0,-10.0,-0.01];


bkg_exp_offset_A1[1.0,0.0,20.0];
bkg_exp_offset_A2[1.0,0.0,10.0];
bkg_exp_offset_B1[1.0,0.0,10.0];
bkg_exp_offset_B2[1.0,0.0,10.0];
bkg_exp_offset_C1[1.0,0.0,10.0];
bkg_exp_offset_C2[1.0,0.0,10.0];

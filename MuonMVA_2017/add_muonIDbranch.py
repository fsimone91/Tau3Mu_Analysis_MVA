...
def add_eval_branch(in_fname='infile.root'):
   ...
   scalefactor = [ array('f', [-99.]), array('f', [-99.]), array('f', [-99.]) ]
   scalefactor_err = [ array('f', [-99.]), array('f', [-99.]), array('f', [-99.]) ]
...
def main():
    #add_eval_branch("/lustre/cms/store/user/fsimone/Tau3Mu/Analysis/20210728_1549/AnalysedTree_data_2017B_tau3mu_28july.root")
    #add_eval_branch("/lustre/cms/store/user/fsimone/Tau3Mu/Analysis/20210728_1550/AnalysedTree_data_2017C_tau3mu_28july.root")
    #add_eval_branch("/lustre/cms/store/user/fsimone/Tau3Mu/Analysis/20210728_1551/AnalysedTree_data_2017D_tau3mu_28july.root")
    #add_eval_branch("/lustre/cms/store/user/fsimone/Tau3Mu/Analysis/20210728_1552/AnalysedTree_data_2017E_tau3mu_28july.root")
    #add_eval_branch("/lustre/cms/store/user/fsimone/Tau3Mu/Analysis/20210728_1553/AnalysedTree_data_2017F_tau3mu_28july.root")
    #add_eval_branch("/lustre/cms/store/user/fsimone/Tau3Mu/Analysis/20210728_2305/AnalysedTree_MC_2017W_tau3mu_28july.root")
    add_eval_branch("/lustre/cms/store/user/fsimone/Tau3Mu/Analysis/20210730_1602/AnalysedTree_MC_2017Ds_tau3mu_30july.root")
    add_eval_branch("/lustre/cms/store/user/fsimone/Tau3Mu/Analysis/20210730_1603/AnalysedTree_MC_2017B0_tau3mu_30july.root")
    add_eval_branch("/lustre/cms/store/user/fsimone/Tau3Mu/Analysis/20210730_1604/AnalysedTree_MC_2017Bp_tau3mu_30july.root")

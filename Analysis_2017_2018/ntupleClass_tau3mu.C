...
// * cut[7] -> mu2 glb 
// * cut[8] -> mu3 glb 
// * cut[9] -> mu1 pt>ptmin (=2) & |eta|<2.4
// * cut[10] -> mu2 pt>ptmin (=2) & |eta|<2.4
// * cut[11] -> mu3 pt>ptmin (=2) & |eta|<2.4
// * cut[12] -> Triplet mass (in 1.62 - 2 GeV)
// * cut[13] -> The 3 possible pairs of mu of the triplet have proper DeltaR (<0.8)
// * cut[14] -> The 3 possible pairs of mu of the triplet have proper |DeltaZ| (<0.5)
// * cut[15] -> Phi(1020) veto on os 2mu mass 
// * cut[16] -> Omega(782) veto on os 2mu mass 
// * cut[17] -> Mu1 Trigger Matching dR<0.03, abs(dpt)/pt<0.1
// * cut[18] -> Mu2 Trigger Matching dR<0.03, abs(dpt)/pt<0.1
// * cut[19] -> Mu3 Trigger Matching dR<0.03, abs(dpt)/pt<0.1
// * cut[20] -> Muon_trackerLayersWithMeasurement >= 7
// Cuts: (over events containing at least 1 triplet)
// * cut[21] -> Final plots sideband
// * cut[22] -> Final plots tau region
// * cut[23] -> Final plots full mass range
//
...
void ntupleClass_tau3mu::Loop(TString type, TString datasetName){
    ...
    //options for output test file (list of events)
    bool doLog = false;
    ...
    //uncomment the following line to analyse 2017 F using 2018 HLT and trigger matching
    //if(datasetName.Contains("2017F")) datasetName = "2018F";

    //for 2017F analysis, run range must be limited to 305044 .. 306029 (excluded), to avoid double counting
    int maxrun_2017F = 306029;
    ...
    if( isMC && doPUrew ) {
        ...
        else fPUweight = "/lustrehome/fsimone/Analysis_2017_2018/Pile_up_reweighing_tools/PileUp_ReweightingStudy_reReco"+datasetName+".root";
    ...
    TString SF_filename = "";
    if (datasetName.Contains("2017")) SF_filename = "/lustrehome/fsimone/Analysis_2017_2018/SF/EfficienciesAndSF2017_MTau3MuCutid_NUM_MTau3MuID_DEN_genTracks_PAR_pt_eta.root";
    if (datasetName.Contains("2018")) SF_filename = "/lustrehome/fsimone/Analysis_2017_2018/SF/EfficienciesAndSF2018_MTau3MuCutid_NUM_MTau3MuID_DEN_genTracks_PAR_pt_eta.root";
    TFile *_f = new TFile(SF_filename);
    TH2F* SF_h = dynamic_cast<TH2F*> (_f->Get("MTau3MuID/pt_abseta_ratio"));
    ...
    double pileupFactor = 0, tripletMuIDSF = 0, tripletMuIDSF_err = 0, Mu1_IDSF = 0, Mu1_IDSF_err = 0, Mu3_IDSF = 0, Mu3_IDSF_err = 0; 
    double Pmu3 = 0, cLP = 0, segmComp = 0, tripletMass = 0, tripletMass2 = 0, tripletMassRef = 0, tripletMassReso = 0, fv_nC = 0, fv_dphi3D = 0, fv_d3D = 0, fv_d3Dsig = 0, bs_sv_d2D = 0, bs_sv_d2Dsig = 0, pv_sv_dxy = 0, pv_sv_dxy_sig = 0, pv_sv_dxy_err = 0, d0 = 0, d0sig = 0, mindca_iso = 0, trkRel = 0, Pmu1 = 0, Ptmu1 = 0, etamu1 = 0, Pmu2 = 0, Ptmu2 = 0, etamu2 = 0, Ptmu3 = 0, etamu3 = 0, P_trip = 0, Pt_trip = 0, eta_trip = 0, nStationsMu1 = 0, nStationsMu2 = 0, nStationsMu3 = 0, Iso03Mu1 = 0, Iso03Mu2 = 0, Iso03Mu3 = 0, Iso05Mu1 = 0, Iso05Mu2 = 0, Iso05Mu3 = 0, nMatchesMu1 = 0, nMatchesMu2 = 0, nMatchesMu3 = 0, timeAtIpInOutMu1 = 0, timeAtIpInOutMu2 = 0, timeAtIpInOutMu3 = 0, cQ_uS = 0, cQ_tK, cQ_gK = 0, cQ_tRChi2 = 0, cQ_sRChi2 = 0, cQ_Chi2LM = 0, cQ_Chi2lD = 0, cQ_gDEP = 0, cQ_tM = 0, cQ_gTP = 0, calEn_emMu1 = 0, calEn_emMu2 = 0, calEn_emMu3 = 0, calEn_hadMu1 = 0, calEn_hadMu2 = 0, calEn_hadMu3 = 0, caloComp = 0, Vx1 = 0, Vx2 = 0, Vx3 = 0, Vy1 = 0, Vy2 = 0, Vy3 = 0, Vz1 = 0, Vz2 = 0, Vz3 = 0, dxy1 = 0, dxy2 = 0, dxy3 = 0, dxyErr1 = 0, dxyErr2 = 0, dxyErr3 = 0, Refvx1 = 0, Refvy1 = 0, Refvz1 = 0, SVx = 0, SVy = 0, SVz = 0;
    double massKK_1 = 0, massKpi_1 = 0;
    double massKK_2 = 0, massKpi_2 = 0;
    double massKK_3 = 0, massKpi_3 = 0;
    double dimu12 = 0, dimu23 = 0, dimu13 = 0, divtx12_13 = 0, divtx12_23 = 0, divtx13_23 = 0, divtxchi2_12 = 0, divtxchi2_23 = 0, divtxchi2_13 = 0, dR_12 = 0, dR_13 = 0, dR_23 = 0;
    double dimu12_ref = 0, dimu23_ref = 0, dimu13_ref = 0;
    double dimu12_ref2 = 0, dimu23_ref2 = 0, dimu13_ref2 = 0;
    double dimu_OS1 = 0, dimu_OS2 = 0;
    ...
    double RefV_x = 0, RefV_y = 0, RefV_z = 0, RefV_cxx = 0, RefV_cxy = 0, RefV_cxz = 0, RefV_cyy = 0, RefV_cyz = 0, RefV_czz = 0, SV_x = 0, SV_y = 0, SV_z = 0, SV_cxx = 0, SV_cxy = 0, SV_cxz = 0, SV_cyy = 0, SV_cyz = 0, SV_czz = 0, RefV_SV_dxy = 0, RefV_SV_dxy_err = 0, RefV_SV_d3D = 0, RefV_SV_d3D_err;
    double mu_id = 0, mu_simeta = 0, mu_simpt = 0, mu_simphi = 0, mu_pterr = 0, pt_reso = 0, triplet_reso = 0, triplet_mass = 0;
    double reftrack_pt = 0, reftrack_eta = 0, reftrack_phi = 0, ref_mass=0;
    ...
    //Creation of HLT log file
    std::ofstream log_hlt_2017, log_hlt_2018, log_hlt_W;
    TString log_HLT2017_fileName = fileName;
    TString log_HLT2018_fileName = fileName;
    TString log_HLTW_fileName = fileName;
    if(doHLTlog) {
        log_hlt_2017.open(log_HLT2017_fileName.ReplaceAll(".root","_hlt2017_logfile.txt"));
        log_hlt_2017 << "run\tlumisection\tevt\n";
        log_hlt_2018.open(log_HLT2018_fileName.ReplaceAll(".root","_hlt2018_logfile.txt"));
        log_hlt_2018 << "run\tlumisection\tevt\n";
        log_hlt_W.open(log_HLTW_fileName.ReplaceAll(".root","_hltW_logfile.txt"));
        log_hlt_W << "run\tlumisection\tevt\n";
    }

    //Read list of events for synch
    //TString compare_filename = "/lustrehome/fsimone/UF_INFN_sync/data_diff_UF_notINFN.txt";
    //std::ifstream compare_input(compare_filename);
    //std::vector< std::array<double, 3> > compare_evt_list;
    //if(isVerbose && doLog_maxcut) cout<<"List events passing UF not INFN:\n"<<compare_filename<<endl;
    //double run_temp, lumi_temp, event_temp, tmp;
    //if(doLog_maxcut){
    //    while (compare_input >> run_temp >> lumi_temp >> event_temp >> tmp >> tmp >> tmp >> tmp >> tmp >> tmp) {
    //        std::array<double, 3> tempList;
    //        tempList[0] = run_temp; tempList[1] = lumi_temp; tempList[2] = event_temp;
    //        compare_evt_list.push_back(tempList);
    ...
    TreeFin_Init(tree_final, run_n, lumi_n, evt_n, pileupFactor, Mu1_IDSF, Mu1_IDSF_err, Mu3_IDSF, Mu3_IDSF_err, l1triple_fired, l1double_fired, l1double_DoubleMu0_fired, l1double_DoubleMu4_fired, Pmu3, cLP, tKink, segmComp, tripletMass, tripletMass2, tripletMassRef, tripletMassReso,  fv_nC, fv_dphi3D, fv_d3D, fv_d3Dsig, bs_sv_d2D, bs_sv_d2Dsig, pv_sv_dxy, pv_sv_dxy_sig, pv_sv_dxy_err, d0, d0sig, mindca_iso, trkRel, Pmu1, Ptmu1, etamu1, Pmu2, Ptmu2, etamu2, Ptmu3, etamu3, dimu12, dimu23, dimu13, dimu12_ref, dimu23_ref, dimu13_ref,  dimu12_ref2, dimu23_ref2, dimu13_ref2, divtx12_13, divtx12_23, divtx13_23, divtxchi2_12, divtxchi2_23, divtxchi2_13, dR_12, dR_13, dR_23, dimu_OS1, dimu_OS2, P_trip, Pt_trip, eta_trip, nStationsMu1, nStationsMu2, nStationsMu3, Iso03Mu1, Iso03Mu2, Iso03Mu3, Iso05Mu1, Iso05Mu2, Iso05Mu3, nMatchesMu1, nMatchesMu2, nMatchesMu3, timeAtIpInOutMu1, timeAtIpInOutMu2, timeAtIpInOutMu3, cQ_uS, cQ_tK, cQ_gK, cQ_tRChi2, cQ_sRChi2, cQ_Chi2LM, cQ_Chi2lD, cQ_gDEP, cQ_tM, cQ_gTP, calEn_emMu1, calEn_emMu2, calEn_emMu3, calEn_hadMu1, calEn_hadMu2, calEn_hadMu3, caloComp, isGlb3, isTracker3, isLoose3, isSoft1, isPF1, isRPC1, isSA1, isCalo1, isMedium1, muID1, isGlb2, isTracker2, isLoose2, isSoft2, isPF2, isRPC2, isSA2, isCalo2, isMedium2, muID2, isGlb3, isTracker3, isLoose3,  isSoft3, isPF3, isRPC3, isSA3, isCalo3, isMedium3, muID3, Vx1, Vx2, Vx3, Vy1, Vy2, Vy3, Vz1, Vz2, Vz3, dxy1, dxy2, dxy3, dxyErr1, dxyErr2, dxyErr3, Refvx1, Refvy1, Refvz1, SVx, SVy, SVz, massKK_1, massKpi_1, massKK_2, massKpi_2, massKK_3, massKpi_3);
    ...
    // mini tree for vertexing studies
    TTree *tree_vtx = new TTree("VertexTree","VertexTree");
    TreeVertex_Init(tree_vtx, ind, RefV_x, RefV_y, RefV_z, RefV_cxx, RefV_cxy, RefV_cxz, RefV_cyy, RefV_cyz, RefV_czz, SV_x, SV_y, SV_z, SV_cxx, SV_cxy, SV_cxz, SV_cyy, SV_cyz, SV_czz, RefV_SV_dxy, RefV_SV_dxy_err, RefV_SV_d3D, RefV_SV_d3D_err);

    // mini tree for resolution studies
    TTree *tree_reso = new TTree("ResoTree","ResoTree");
    TreeReso_Init(tree_reso, mu_id, mu_eta, mu_pt, mu_phi, mu_simeta, mu_simpt, mu_simphi, mu_pterr, pt_reso, triplet_reso, triplet_mass, reftrack_pt, reftrack_eta, reftrack_phi, ref_mass);
    ...
    TH1D *hEtaMu1_GenMatch = new TH1D("hEtaMu1_GenMatch", "hEtaMu1_GenMatch", 80, -2.45, 2.45); // binning 0.05
    TH1D *hEtaMu2_GenMatch = new TH1D("hEtaMu2_GenMatch", "hEtaMu2_GenMatch", 80, -2.45, 2.45); // binning 0.05
    TH1D *hEtaMu3_GenMatch = new TH1D("hEtaMu3_GenMatch", "hEtaMu3_GenMatch", 80, -2.45, 2.45); // binning 0.05
    TH1D *hPtMu1_GenMatch = new TH1D("hPtMu1_GenMatch", "hPtMu1_GenMatch", 80, 0.0, 40); // binning 0.05
    TH1D *hPtMu2_GenMatch = new TH1D("hPtMu2_GenMatch", "hPtMu2_GenMatch", 80, 0.0, 40); // binning 0.05
    TH1D *hPtMu3_GenMatch = new TH1D("hPtMu3_GenMatch", "hPtMu3_GenMatch", 80, 0.0, 40); // binning 0.05
    ...
    TH1I *hNtripl; TH1F *hChi2Track, *hmassQuad, *hmassQuad_Zero, *hSegmComp;
    ...
    TH2D *hPtRes_Pt_AC, *hPtRes_Eta_AC;
    ...
    hEtaC->Sumw2();
    InitHistoAC(hNtripl, hSegmComp, hChi2Track, hMassTriRes, hMassTriResBarrel, hMassTriResEndcap, hmassdi, hmassQuad, hmassQuad_Zero, hPtRes_AC, hPtRes_Pt_AC, hPtRes_Eta_AC, hPtRes_AC_mu, hPtResBarrel_AC, hPtResBarrel_AC_mu, hPtResEndcap_AC, hPtResEndcap_AC_mu, hNMatchedStat, hFlightDist, hFlightDist_Signif, hFlightDistvsP, hPtErrOverPt, hPt_tripl_good, hPt_tripl_fake, hDeltaX, hDeltaY, hDeltaZ, hDeltaX_fake, hDeltaY_fake, hDeltaZ_fake);
	...
	ntripl = 0, trInd = 0; int cuttripl[NCUTS] = {0}; int cuttriplSignal[NCUTS] = {0};
        ...
        //Register info on common events wrt list
        std::vector<Int_t> max_cut;
        //currentEvent[0] = run; currentEvent[1] = lumi; currentEvent[2] = evt;
        //if (std::find(compare_evt_list.begin(), compare_evt_list.end(), currentEvent) != compare_evt_list.end()) {
        ...
        for(int h=0; h<Trigger_hltname->size(); h++) {
            ...
            //HLT
            if( (
                (datasetName.Contains("2016") && strncmp(hltName, "HLT_DoubleMu3_Trk_Tau3mu_v", 26) == 0 ) ||   // 2016+2017
                (datasetName.Contains("2017") && strncmp(hltName, "HLT_DoubleMu3_Trk_Tau3mu_v", 26) == 0 ) ||   // 2016+2017
                (datasetName.Contains("2018") && strncmp(hltName, "HLT_DoubleMu3_TkMu_DsTau3Mu_v", 29) == 0 ) ) //2018
                && Trigger_hltdecision->at(h) == 1) {
                hlt_fired = 1;
                n_hltfired++;
            }
            //HLT W channel
            if( (
                (datasetName.Contains("W") && strncmp(hltName, "HLT_Tau3Mu_Mu7_Mu1_TkMu1_IsoTau15_Charge1", 41) == 0 ) ) //W MC
                && Trigger_hltdecision->at(h) == 1) {
                hlt_W_fired = 1;
            }
        }
        ...
        //recording event list fired by different HLTs
        if(doHLTlog){
            for(int h=0; h<Trigger_hltname->size(); h++) {
                TString hltName = Trigger_hltname->at(h);
                //HLT
                if( strncmp(hltName, "HLT_DoubleMu3_Trk_Tau3mu_v", 26) == 0    ) log_hlt_2017 << run << "\t" << lumi << "\t" << evt << "\n";
                if( strncmp(hltName, "HLT_DoubleMu3_TkMu_DsTau3Mu_v", 29) == 0 ) log_hlt_2018 << run << "\t" << lumi << "\t" << evt << "\n";
                if( strncmp(hltName, "HLT_Tau3Mu_Mu7_Mu1_TkMu1_IsoTau15_Charge1", 41) == 0 ) log_hlt_W << run << "\t" << lumi << "\t" << evt << "\n";
            }
        }
        ...
        std::vector<double> trigPt;
        if(datasetName.Contains("2018")) trigPt = *MuonPt_HLT;
        if(datasetName.Contains("2017")) trigPt = *MuonPt_HLT2017;
        ...
        for (int j=0; j<TripletVtx_Chi2->size(); j++){
            ...
            if(isVerbose){
                ...
                if(isMC && !(datasetName.Contains("2016"))){
                    ...
                    cout<<" | "<<Muon_simPdgId->at(mu[0])<<" | "<<Muon_simPdgId->at(mu[1])<<" | "<<Muon_simPdgId->at(mu[2])<<endl;
                    cout<<" | mu1_MotherpdgID | mu2_MotherpdgId | mu3_MotherpdgId "<<endl;
                    cout<<" | "<<Muon_simMotherPdgId->at(mu[0])<<" | "<<Muon_simMotherPdgId->at(mu[1])<<" | "<<Muon_simMotherPdgId->at(mu[2])<<endl;
                }
            }
            ...
            if(isSignal){
                hEtaMu1_GenMatch->Fill(Mu1_Eta->at(j));
                hEtaMu2_GenMatch->Fill(Mu2_Eta->at(j));
                hEtaMu3_GenMatch->Fill(Mu3_Eta->at(j));
                hPtMu1_GenMatch->Fill(Mu1_Pt->at(j));
                hPtMu2_GenMatch->Fill(Mu2_Pt->at(j));
                hPtMu3_GenMatch->Fill(Mu3_Pt->at(j));
            }
...
//            FillHistoBC("MC", j, hMass_tripl_BC, hChi2Vertex, hMassvsChi2, hMass_quad_BC, hMass_quad_Zero_BC, hMass_di_Zero_BC, hMass_di_Zero2_BC, hPtRes_BC, hPtRes_BC_mu, hPtResBarrel_BC, hPtResBarrel_BC_mu, hPtResEndcap_BC, hPtResEndcap_BC_mu, IdsummaryDaughter_Gen, IdsummaryMother_Gen, Idsummary2D_Gen);
            ...
            //CUT 2 : HLT fired
            //if(!hlt_fired ) continue;//in 2018 ntuples no filter on HLT --> many events have 0 trigger objects
            if(!hlt_fired || ( datasetName.Contains("2018") && MuonPt_HLT->size()==0 ) || ( datasetName.Contains("2017") && MuonPt_HLT2017->size()==0 ) ) continue;//in 2018 ntuples no filter on HLT --> many events have 0 trigger objects
            ...
            //Int_t MCeventClass = MCeventClassifier(mu, j);
            //cout<<"MCeventClass = "<<MCeventClass<<endl;
            ...
            if( (Muon_isPF->at(mu[0]) == 0) || (Muon_isPF->at(mu[1]) == 0) ) continue;
              Ncut++; cut[Ncut]++; cuttripl[Ncut]++;
              max_cut.push_back(Ncut);
              if(isSignal) {cutSignal[Ncut]++; cuttriplSignal[Ncut]++;}
              if (isVerbose) cout<<j<<"   passed cut "<<Ncut<<endl;
            ...
            // CUT 6 // Check that mu1 is glb
            if( !(Muon_isGlobal->at(mu[0]) == 1) ) continue;
              Ncut++; cut[Ncut]++; cuttripl[Ncut]++;
              max_cut.push_back(Ncut);
              if(isSignal) {cutSignal[Ncut]++; cuttriplSignal[Ncut]++;}
              if (isVerbose) cout<<j<<"    passed cut "<<Ncut<<endl;
            ...
            // CUT 7 // Check that mu2 is glb
            if( !(Muon_isGlobal->at(mu[1]) == 1) ) continue;
              Ncut++; cut[Ncut]++; cuttripl[Ncut]++;
              max_cut.push_back(Ncut);
              if(isSignal) {cutSignal[Ncut]++; cuttriplSignal[Ncut]++;}
              if (isVerbose) cout<<j<<"    passed cut "<<Ncut<<endl;
            ...
            // CUT 8 // Check that mu3 is glb
            if( !(Muon_isGlobal->at(mu[2]) == 1) ) continue;
              Ncut++; cut[Ncut]++; cuttripl[Ncut]++;
              max_cut.push_back(Ncut);
              if(isSignal) {cutSignal[Ncut]++; cuttriplSignal[Ncut]++;}
              if (isVerbose) cout<<j<<"    passed cut "<<Ncut<<endl;
            ...
            //CUT 13: Loop on PAIRS of muons of the triplet & check DeltaR
            ...
            if(datasetName.Contains("2017") && MuonPt_HLT2017->size()>0) trigIndex_deltaR = trigMatchDeltaR(j, Muon_HLT2017, false);
            ...
            if(datasetName.Contains("2018") && MuonPt_HLT->size()>0) {
                dR1 = dR( Mu1_Eta->at(j), Muon_HLT[trigIndex_deltaR[0]][1], Mu1_Phi->at(j), Muon_HLT[trigIndex_deltaR[0]][2]);
                dR2 = dR( Mu2_Eta->at(j), Muon_HLT[trigIndex_deltaR[1]][1], Mu2_Phi->at(j), Muon_HLT[trigIndex_deltaR[1]][2]);
                dR3 = dR( Mu3_Eta->at(j), Muon_HLT[trigIndex_deltaR[2]][1], Mu3_Phi->at(j), Muon_HLT[trigIndex_deltaR[2]][2]);
            }
            if(datasetName.Contains("2017") && MuonPt_HLT2017->size()>0) {
                dR1 = dR( Mu1_Eta->at(j), Muon_HLT2017[trigIndex_deltaR[0]][1], Mu1_Phi->at(j), Muon_HLT2017[trigIndex_deltaR[0]][2]);
                dR2 = dR( Mu2_Eta->at(j), Muon_HLT2017[trigIndex_deltaR[1]][1], Mu2_Phi->at(j), Muon_HLT2017[trigIndex_deltaR[1]][2]);
                dR3 = dR( Mu3_Eta->at(j), Muon_HLT2017[trigIndex_deltaR[2]][1], Mu3_Phi->at(j), Muon_HLT2017[trigIndex_deltaR[2]][2]);
            }
            ...
            if(datasetName.Contains("2018") && MuonPt_HLT->size()>0) {
                ...
                dP3 = std::abs(Muon_HLT[trigIndex_deltaR[2]][0] - MuonPt->at(mu[2]))/MuonPt->at(mu[2]);
            }
            if(datasetName.Contains("2017") && MuonPt_HLT2017->size()>0) {
                ...
                dP3 = std::abs(Muon_HLT2017[trigIndex_deltaR[2]][0] - MuonPt->at(mu[2]))/MuonPt->at(mu[2]);
            }
            ...
            // CUT 18: Mu2 dR and dP Trigger Matching
            ...
            // CUT 19: Mu3 dR and dP Trigger Matching
...
//              cout<<"MCeventClass = "<<MCeventClass<<endl;
        ...
        if(ntripl > 0 && isTrigger_forAna) {
            ...
            //muon pt resolution after cuts
            if( isMC ) FillHistoResoPt_AC(muGen, hPtRes_AC, hPtRes_Pt_AC, hPtRes_Eta_AC, hPtRes_AC_mu, hPtResBarrel_AC, hPtResBarrel_AC_mu, hPtResEndcap_AC, hPtResEndcap_AC_mu);
            ...
            //muon scale factors                
            sfMuon sfMu1, sfMu2, sfMu3;
            sfMu1 = GetMuonSF(SF_h, Mu1_Pt->at(mu_Ind[0]), Mu1_Eta->at(mu_Ind[0]));
            if(isVerbose) cout<<"scaleFactor Mu1="<<sfMu1.value<<" +- "<<sfMu1.error<<endl;
            sfMu2 = GetMuonSF(SF_h, Mu2_Pt->at(mu_Ind[1]), Mu2_Eta->at(mu_Ind[1]));
            if(isVerbose) cout<<"scaleFactor Mu2="<<sfMu2.value<<" +- "<<sfMu2.error<<endl;
            sfMu3 = GetMuonSF(SF_h, Mu3_Pt->at(mu_Ind[2]), Mu3_Eta->at(mu_Ind[2]));
            if(isVerbose) cout<<"scaleFactor Mu3="<<sfMu3.value<<" +- "<<sfMu3.error<<endl;
            Mu1_IDSF =     sfMu1.value;
            Mu1_IDSF_err = sfMu1.error;
            Mu3_IDSF =     sfMu3.value;
            Mu3_IDSF_err = sfMu3.error;
            ...
            //event MiniTree
            TreeFin_Fill(tree_final, ind, mu_Ind, mu, run_n, lumi_n, evt_n, pileupFactor, Mu1_IDSF, Mu1_IDSF_err, Mu3_IDSF, Mu3_IDSF_err, l1triple_fired, l1double_fired, l1double_DoubleMu0_fired, l1double_DoubleMu4_fired, Pmu3, cLP, tKink, segmComp, tripletMass, tripletMass2, tripletMassRef, tripletMassReso, fv_nC, fv_dphi3D, fv_d3D, fv_d3Dsig, bs_sv_d2D, bs_sv_d2Dsig, pv_sv_dxy, pv_sv_dxy_sig, pv_sv_dxy_err, d0, d0sig, mindca_iso, trkRel, Pmu1, Ptmu1, etamu1, Pmu2, Ptmu2, etamu2, Ptmu3, etamu3, dimu12, dimu23, dimu13, dimu12_ref, dimu23_ref, dimu13_ref,  dimu12_ref2, dimu23_ref2, dimu13_ref2, divtx12_13, divtx12_23, divtx13_23, divtxchi2_12, divtxchi2_23, divtxchi2_13, dR_12, dR_13, dR_23, dimu_OS1, dimu_OS2, P_trip, Pt_trip, eta_trip, nStationsMu1, nStationsMu2, nStationsMu3, Iso03Mu1, Iso03Mu2, Iso03Mu3, Iso05Mu1, Iso05Mu2, Iso05Mu3, nMatchesMu1, nMatchesMu2, nMatchesMu3, timeAtIpInOutMu1, timeAtIpInOutMu2, timeAtIpInOutMu3, cQ_uS, cQ_tK, cQ_gK, cQ_tRChi2, cQ_sRChi2, cQ_Chi2LM, cQ_Chi2lD, cQ_gDEP, cQ_tM, cQ_gTP, calEn_emMu1, calEn_emMu2, calEn_emMu3, calEn_hadMu1, calEn_hadMu2, calEn_hadMu3, caloComp, isGlb3, isTracker3, isLoose3, isSoft1, isPF1, isRPC1, isSA1, isCalo1, isMedium1, muID1, isGlb2, isTracker2, isLoose2, isSoft2, isPF2, isRPC2, isSA2, isCalo2, isMedium2, muID2, isGlb3, isTracker3, isLoose3,  isSoft3, isPF3, isRPC3, isSA3, isCalo3, isMedium3, muID3, Vx1, Vx2, Vx3, Vy1, Vy2, Vy3, Vz1, Vz2, Vz3, dxy1, dxy2, dxy3, dxyErr1, dxyErr2, dxyErr3, Refvx1, Refvy1, Refvz1, SVx, SVy, SVz, massKK_1, massKpi_1, massKK_2, massKpi_2, massKK_3, massKpi_3);
            //Muon MiniTree
            ...
            //Vertex MiniTree
            TreeVertex_Fill(tree_vtx, ind, RefV_x, RefV_y, RefV_z, RefV_cxx, RefV_cxy, RefV_cxz, RefV_cyy, RefV_cyz, RefV_czz, SV_x, SV_y, SV_z, SV_cxx, SV_cxy, SV_cxz, SV_cyy, SV_cyz, SV_czz, RefV_SV_dxy, RefV_SV_dxy_err, RefV_SV_d3D, RefV_SV_d3D_err);

            //Resolution MiniTree for MC studies
            if(isMC) TreeReso_Fill(tree_reso, ind, mu_Ind, mu, muGen, mu_id, mu_eta, mu_pt, mu_phi, mu_simeta, mu_simpt, mu_simphi, mu_pterr, pt_reso, triplet_reso, triplet_mass, reftrack_pt, reftrack_eta, reftrack_phi, ref_mass);
            for(int k=0; k<NMU; k++){
            ...
            FillHistoAC(ind, mu, hSegmComp, hChi2Track, hNMatchedStat, hFlightDist, hFlightDist_Signif, hFlightDistvsP, hPtErrOverPt, hmassdi, dimu, hmassQuad, hmassQuad_Zero);

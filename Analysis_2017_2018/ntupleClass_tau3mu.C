...
//            if(Muon_trackerLayersWithMeasurement->at(mu[2]) < 7) continue;
        ...
        if(ntripl > 0 && isTrigger_forAna) {
            ...
            if(isMC && datasetName.Contains("2017")) { smearing = 0.0090; dxy_shift = 1.1; }
            //event MiniTree
            TreeFin_Fill(tree_final, ind, mu_Ind, mu, run_n, lumi_n, evt_n, pileupFactor, l1triple_fired, l1double_fired, l1double_DoubleMu0_fired, l1double_DoubleMu4_fired, Pmu3, cLP, tKink, segmComp, tripletMass, tripletMassRef, tripletMassReso, fv_nC, fv_dphi3D, fv_d3D, fv_d3Dsig, bs_sv_d2D, bs_sv_d2Dsig, pv_sv_dxy, pv_sv_dxy_sig, pv_sv_dxy_err, pv_sv_dxy_smeared, pv_sv_dxy_sig_corrected, smearing, dxy_shift, d0, d0sig, mindca_iso, trkRel, Pmu1, Ptmu1, etamu1, Pmu2, Ptmu2, etamu2, Ptmu3, etamu3, dimu12, dimu23, dimu13, divtx12_13, divtx12_23, divtx13_23, divtxchi2_12, divtxchi2_23, divtxchi2_13, dR_12, dR_13, dR_23, P_trip, Pt_trip, eta_trip, nStationsMu1, nStationsMu2, nStationsMu3, Iso03Mu1, Iso03Mu2, Iso03Mu3, Iso05Mu1, Iso05Mu2, Iso05Mu3, nMatchesMu1, nMatchesMu2, nMatchesMu3, timeAtIpInOutMu1, timeAtIpInOutMu2, timeAtIpInOutMu3, cQ_uS, cQ_tK, cQ_gK, cQ_tRChi2, cQ_sRChi2, cQ_Chi2LM, cQ_Chi2lD, cQ_gDEP, cQ_tM, cQ_gTP, calEn_emMu1, calEn_emMu2, calEn_emMu3, calEn_hadMu1, calEn_hadMu2, calEn_hadMu3, caloComp, isGlb3, isTracker3, isLoose3, isSoft1, isPF1, isRPC1, isSA1, isCalo1, isMedium1, muID1, isGlb2, isTracker2, isLoose2, isSoft2, isPF2, isRPC2, isSA2, isCalo2, isMedium2, muID2, isGlb3, isTracker3, isLoose3,  isSoft3, isPF3, isRPC3, isSA3, isCalo3, isMedium3, muID3, Vx1, Vx2, Vx3, Vy1, Vy2, Vy3, Vz1, Vz2, Vz3, dxy1, dxy2, dxy3, dxyErr1, dxyErr2, dxyErr3, Refvx1, Refvy1, Refvz1, SVx, SVy, SVz, had03, had05, nJets03, nJets05, nTracks03, nTracks05, sumPt03, sumPt05, hadVeto03, hadVeto05, emVeto03, emVeto05, trVeto03, trVeto05);
            //Muon MiniTree

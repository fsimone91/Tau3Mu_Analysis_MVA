...
void KS_test_CV(){
    KS_test_parser("A",TMVA_inputpath, "1");   
    KS_test_parser("A",TMVA_inputpath, "2");   
    KS_test_parser("A",TMVA_inputpath, "3");   
    KS_test_parser("A",TMVA_inputpath, "4");   
    KS_test_parser("A",TMVA_inputpath, "5");   

    KS_test_parser("B",TMVA_inputpath, "1");   
    KS_test_parser("B",TMVA_inputpath, "2");   
    KS_test_parser("B",TMVA_inputpath, "3");   
    KS_test_parser("B",TMVA_inputpath, "4");   
    KS_test_parser("B",TMVA_inputpath, "5");   

    KS_test_parser("C",TMVA_inputpath, "1");   
    KS_test_parser("C",TMVA_inputpath, "2");   
    KS_test_parser("C",TMVA_inputpath, "3");   
    KS_test_parser("C",TMVA_inputpath, "4");   
    KS_test_parser("C",TMVA_inputpath, "5");   
}
